...
<html>
  <head>
    ...
    <meta property="og:title" content="Milo Axelrod | Catskills Conf">
    <meta property="og:description" content="Freelance graphic designer based in New Paltz, NY.">
    <meta property="og:url" content="http://www.miloaxelrod.com/catskills-conf.php">
    ...
    <meta name=”twitter:url” content=”http://www.miloaxelrod.com/catskills-conf.php”>
    <meta name="twitter:site" content="@miloaxelrod">
    <meta name="twitter:title" content="Milo Axelrod | Catskills Conf">
  ...
  <div class="page project">
    <div class="section last">
      ...
      <div class="paragraph">
        ...
        <p>Every year a different designer is chosen to brand Catskills Conf, and I have been lucky enough to be given the opportunity for 2017. The website was the first deliverable, and will be followed by signage, clothing designs, program booklets, posters, name badges, pins, stickers, and more!</p>
      </div>
      ...
      <div class="image-cont">
        <div class="image-1">
          <img src="img/projects/catskills-conf/mockup5.png" />
        </div>
      </div>
